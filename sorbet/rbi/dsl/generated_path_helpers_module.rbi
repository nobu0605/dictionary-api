...
module GeneratedPathHelpersModule
  ...
  def api_auth_validate_token_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_search_word_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_user_password_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_user_registration_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_user_session_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def cancel_api_user_registration_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def destroy_api_user_session_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_user_password_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_user_registration_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_user_password_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_user_registration_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_user_session_path(*args); end
