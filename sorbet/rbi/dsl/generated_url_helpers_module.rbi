...
module GeneratedUrlHelpersModule
  ...
  def api_auth_validate_token_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_search_word_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_user_password_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_user_registration_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_user_session_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def cancel_api_user_registration_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def destroy_api_user_session_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_user_password_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_user_registration_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_user_password_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_user_registration_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_user_session_url(*args); end
