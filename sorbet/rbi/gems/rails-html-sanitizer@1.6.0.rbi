...
module ActionView
  class << self
    # source://actionview/7.0.8/lib/action_view.rb#90
    def eager_load!; end

    # source://actionview/7.0.8/lib/action_view/gem_version.rb#5
    def gem_version; end

    # source://actionview/7.0.8/lib/action_view/version.rb#7
    def version; end
  end
end
...
module ActionView::Helpers::SanitizeHelper
  ...
  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#81
  def sanitize(html, options = T.unsafe(nil)); end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#86
  def sanitize_css(style); end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#120
  def strip_links(html); end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#103
  def strip_tags(html); end
end

# source://rails-html-sanitizer//lib/rails-html-sanitizer.rb#17
module ActionView::Helpers::SanitizeHelper::ClassMethods
  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#145
  def full_sanitizer; end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#125
  def full_sanitizer=(_arg0); end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#155
  def link_sanitizer; end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#125
  def link_sanitizer=(_arg0); end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#165
  def safe_list_sanitizer; end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#125
  def safe_list_sanitizer=(_arg0); end

  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#135
  ...
  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#131
  ...
  # source://actionview/7.0.8/lib/action_view/helpers/sanitize_helper.rb#127
